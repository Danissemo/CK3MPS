...
internal static class RestoreManifestHarness
{
    ...
    private static int Main(string[] args)
    {
        ...
        try
        {
            ...
            File.WriteAllText(manifestPath, BuildManifest(sourceA, sourceB, backupA, backupB), new UTF8Encoding(false));
            ...
            try
            {
                ...
                Assert(count == 7, "all seven manifest rows should remain visible for operator review");
    ...
    private static string BuildManifest(string sourceA, string sourceB, string backupA, string backupB)
    {
